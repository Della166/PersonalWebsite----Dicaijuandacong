...
<DemoStatus
  title="Live demo · faithful walkthrough of the real notebook"
  description="The interactive demo mirrors 案例7 notebook 企业私有化Nl2SQL模型微调实战.ipynb verbatim: the 6-step data_create pipeline, the actual llamafactory-cli train command (Qwen3-4B LoRA r=8 α=16), the real predict_with_generate eval table (BLEU-4 10.25 → 22.90, ROUGE-L 10.31 → 28.05), and the DeepSeek-Coder 6.7B branch metrics (91% syntax-valid, 61% execution-match)."
/>
