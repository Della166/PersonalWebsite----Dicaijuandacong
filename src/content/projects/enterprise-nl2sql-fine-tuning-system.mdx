...
<DemoStatus
  title="Live demo · schema + NL2SQL + 4-axis validation"
  description="The interactive demo is now live: pick one of three preset enterprise schemas, switch between NL prompts, read the generated SQL, and inspect the four validation signals (syntax / schema-bound / executes / semantic match) the project's eval pipeline computes per query."
/>
